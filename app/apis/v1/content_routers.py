...
@content_router.get(
    ...
    description=(
        ...
        "로그인한 프로필에 질환(conditions)이 등록되어 있으면 그 질환들의 콘텐츠만(personalized=true), "
