...
async def screen_basic(
    ...
    return await service.screen_basic(body.drug_names)
...
async def screen_interaction(
    ...
    """
    service = DurScreeningService()
    return await service.screen_interactions(body.drug_names)
...
async def screen_ingredient(
    ...
    """
    service = DurScreeningService()
    return await service.screen_ingredients(body.drug_names)
