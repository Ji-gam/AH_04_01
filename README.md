...
| 단계 | 문서 | 언제 보는가 |
| --- | --- | --- |
| 1. 진입(매 세션) | `CLAUDE.md`, `AGENT_PLAYBOOK.md` | 작업 시작 전 항상 |
| 2. 참조(필요할 때) | `docs/CODING_RULES.md`, `docs/CONTRIBUTING.md`, `docs/decision_log.md`, `docs/squad-map.md` | T-ID 작업, 구조/소유권 확인, "왜 이렇게 됐는지" 찾을 때 |
...
문서 버전 관리 규칙(파일명 고정, 헤더 버전업)은 `CLAUDE.md`의 "문서 버전 관리" 참고.
